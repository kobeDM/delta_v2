...
#
# createProject.tcl: Tcl script for re-creating project 'digital_64_v2'
#
# Generated by Vivado on Tue Feb 16 19:26:15 +0900 2021
...
set _xil_proj_name_ "digital_64_v2"
...
set file "src/SiTCP_XC7A_32K_BBT_V80.ngc"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "ADC_SiTCP_V20" -objects $obj
...
# Set 'sources_1' fileset file properties for local files
set file "c_accum_0/c_accum_0.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "c_addsub_2/c_addsub_2.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "sys_mmcms/sys_mmcms.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "mem_gen_8_4K/mem_gen_8_4K.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files *constrs/digital_31_0.xdc]" -objects $obj
set_property -name "target_part" -value "xc7a200tffg1156-2" -objects $obj
set_property -name "target_ucf" -value "[get_files *constrs/digital_31_0.xdc]" -objects $obj
...
set_property -name "top" -value "TB_TRIGGER" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a200tffg1156-2 -flow {Vivado Synthesis 2015} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a200tffg1156-2 -flow {Vivado Implementation 2020} -strategy "Flow_Quick" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
